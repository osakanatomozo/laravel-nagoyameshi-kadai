...
class RestaurantTest extends TestCase
{
    ...
    public function test_general_user_can_access_restaurants_index()
    {
    ...
    public function test_admin_cannot_access_restaurants_index()
    {
        ...
        $response->assertRedirect(route('admin.home')); // 管理者リダイレクト先
    }
    ...
    public function test_general_user_can_access_restaurants_show()
    {
        $user = User::factory()->create();
        $restaurant = Restaurant::factory()->create();
