...
class SubscriptionTest extends TestCase
{
    ...
    public function test_general_user_can_access_subscription_create()
    {
    ...
    public function test_subscription_user_cannot_access_subscription_create()
    {
        $user = User::factory()->create();
    ...
    public function test_subscription_user_cannot_access_subscription_store()
    {
        $user = User::factory()->create();
        $user->newSubscription('premium_plan', 'price_1QNEDuFMjCpqJdkeqoMnaOGL')->create('pm_card_visa');
    ...
    public function test_general_user_can_access_subscription_edit()
    {
        $user = User::factory()->create();
